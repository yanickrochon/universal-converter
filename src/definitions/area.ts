...
const areaDef = buildUnitDef({
  ...
  units: {
    ...
    "square astronomical unit": 2.2379523e22,
  ...
  conversion: {
    ...
    converters: {
      squareArea: ({ width = 0 }) => width * width,
      rectangleArea: ({ width = 0, length = 0 }) => width * length,
    },
  },
});

export type AreaType = typeof areaDef;
export default areaDef;
