...
const accelerationDef = buildUnitDef({
  type: "acceleration",
  ...
  conversion: {
    ...
    converters: {
      velocityOverTime: ({ velocity = 0, initialVelocity = 0, time = 0 }) =>
        (velocity - initialVelocity) / time,
    },
  },
});

export type AccelerationType = typeof accelerationDef;
export default accelerationDef;
