...
async function addLicense(packageData) {
  const license = `/** @license Perfect-Data v${packageData.version}
 *
...
`;
  await Promise.all(
    [
      './index.js',
      './esm/index.js',
      './umd/universal-converter.js',
      './umd/universal-converter.min.js',
    ].map(async file => {
      try {
...
async function run() {
  try {
    ...
    await Promise.all(
      [
        // use enhanced readme from workspace root for `universal-converter`
        './README.md',
        './LICENSE',
