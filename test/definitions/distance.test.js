...
describe('Testing Distance definition', function () {
  ...
  it('should calculate from conversion', function () {
    def.conversion.converters.square(100).should.equal(10);
    def.conversion.converters.rectangle(500, 10).should.equal(50);

    def.conversion.converters.square(1).should.equal(def.units['meter']);
    def.conversion.converters.square(100).should.equal(10 * def.units['meter']);
